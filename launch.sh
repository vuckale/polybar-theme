...
color_env() {
    ...
    # export variables
    export BACKGROUND FOREGROUND FOREGROUND_ALT ALERT DATE_MODULE_HELPER\ 
    DATE_MODULE_HELPER_ALT DATE_MODULE_CALENDAR FOREGROUND_TINT_0\ 
    FOREGROUND_TINT_1 FOREGROUND_TINT_2 FOREGROUND_TINT_3 FOREGROUND_EMPTY\ 
    OPEN_WEATHER_API_KEY WEATHER_CHANNEL_PY_URL
}
